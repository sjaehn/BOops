...
LeftButton::LeftButton () :
		LeftButton (0.0, 0.0, BWIDGETS_DEFAULT_BUTTON_WIDTH, BWIDGETS_DEFAULT_BUTTON_HEIGHT, "upbutton", 0.0) {}

LeftButton::LeftButton (const double x, const double y, const double width, const double height, const std::string& name, double defaultValue) :
		Button (x, y, width, height, name, defaultValue) {}

Widget* LeftButton::clone () const {return new LeftButton (*this);}

void LeftButton::draw (const BUtilities::RectArea& area)
{
