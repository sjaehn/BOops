...
PlusButton::PlusButton () :
		PlusButton (0.0, 0.0, BWIDGETS_DEFAULT_BUTTON_WIDTH, BWIDGETS_DEFAULT_BUTTON_HEIGHT, "upbutton", 0.0) {}

PlusButton::PlusButton (const double x, const double y, const double width, const double height, const std::string& name, double defaultValue) :
		Button (x, y, width, height, name, defaultValue) {}

Widget* PlusButton::clone () const {return new PlusButton (*this);}

void PlusButton::draw (const BUtilities::RectArea& area)
{
