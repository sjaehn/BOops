...
#ifndef OPTIONTREMOLO_HPP_
#define OPTIONTREMOLO_HPP_
...
class OptionTremolo : public OptionWidget
{
public:
	OptionTremolo () : OptionTremolo (0.0, 0.0, 0.0, 0.0, "widget") {}
		...
		shapeLabel (170, 90, 90, 20, "ctlabel", BOOPS_LABEL_SHAPE)
	{
		try
		{
			options[0] = new DialRange (10, 20, 60, 60, "pad0", 0.5, 0.0, 1.0, 0.0, BIDIRECTIONAL, "%1.2f", "Hz", [] (double x) {return 1.0 + 19.0 * x;}, [] (double x) {return (LIMIT (x, 1.0, 20.0) - 1.0) / 19.0;});
	...
	virtual Widget* clone () const override {return new OptionTremolo (*this);}
