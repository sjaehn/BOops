...
#define BWIDGETS_DEFAULT_SAMPLECHOOSER_PLAY_AS_LOOP_INDEX 5
#define BWIDGETS_DEFAULT_SAMPLECHOOSER_FILE_INDEX 6
#define BWIDGETS_DEFAULT_SAMPLECHOOSER_SELECTION_START_INDEX 7
#define BWIDGETS_DEFAULT_SAMPLECHOOSER_SELECTION_END_INDEX 8
#define BWIDGETS_DEFAULT_SAMPLECHOOSER_FRAMES_INDEX 9
#define BWIDGETS_DEFAULT_SAMPLECHOOSER_NO_FILE_INDEX 10
